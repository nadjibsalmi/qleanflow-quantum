  ...
  return (
    <>
      ...
      <main className="flex-1 p-6 space-y-6 max-w-3xl">
        ...
        <Card title="Dataset">
          <p className="text-sm text-muted leading-relaxed">
            The dataset covers 500 communities across 16 regions of Ghana, with 22
            recorded features per community plus the target label: geographic location,
            distance to the nearest river, proximity to known mining zones, water source
            type, sanitation infrastructure, household income, education level, and the
            presence of government or NGO intervention, alongside the target label (water
            quality: safe or unsafe) and a graded contamination level.
          </p>
        </Card>
        ...
        <Card title="Why compare classical and quantum approaches">
          <p className="text-sm text-muted leading-relaxed">
            ...
            simulators. Three approaches are trained on identical preprocessed data so
            their performance is directly comparable: a classical SVM baseline, a Quantum
            SVC (a classical SVM using a quantum-computed kernel), and a Quantum Neural
            Network (a variational circuit trained end-to-end with gradient descent). See
            the{" "}
